...
DEFAULT_RESULTS_ROOT = Path(__file__).resolve().parent / "multi_horizon_results_gpformer_fewshot_raw"
DEFAULT_LOG_STEM = "predict_glucose_multiwindow_gpformer_fewshot_raw"
