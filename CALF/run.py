...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_windows_per_epoch', type=int, default=-1)
    parser.add_argument('--test_root_path', type=str, default=None)

    # evaluation control
    parser.add_argument('--per_subject_eval', type=int, default=0)
    parser.add_argument('--stride', type=int, default=1, help='Sliding window stride (step size) for time series windows')
