...
def vali(
    ...
    with torch.no_grad():
        for i, batch in tqdm(enumerate(vali_loader)):
            # =================================================
            # ✅ Support both 4-tuple and 5-tuple batches
            # =================================================
            if len(batch) == 4:
            ...
            # ==========================
            # NEW: store subject_ids
            # ==========================
            if return_subject_ids and subject_ids is not None:
                # subject_ids is a list[str] of length batch_size
    ...
    # ==========================
    # Return logic (fully backward compatible)
    # ==========================
    if return_preds:
        ...
        if return_subject_ids:
            return total_loss, total_mae_loss, all_preds, all_trues, all_subject_ids
        else:
            return total_loss, total_mae_loss, all_preds, all_trues
    else:
