# TimesFM - GlucoseML Benchmark

Only 3 runnable scripts are kept under `timesfm/`:

- Zero-shot: `timesfm/predict_glucose_multiwindow_timesfm_zeroshot.py`
- Full-shot: `timesfm/predict_glucose_multiwindow_timesfm_fullshot.py`
- Few-shot: `timesfm/predict_glucose_multiwindow_timesfm_fewshot.py` (same as full-shot, except `--train-stride-steps` defaults to 240)
...
After running, results are written under `timesfm/`:

- Zero-shot: `timesfm/multi_horizon_results_timesfm_zeroshot/`
- Full-shot: `timesfm/multi_horizon_results_timesfm_fullshot/`
- Few-shot: `timesfm/multi_horizon_results_timesfm_fewshot/`
