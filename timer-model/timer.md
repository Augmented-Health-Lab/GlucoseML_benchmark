...
```
python timer-model/predict_glucose_multiwindow_timer_zeroshot.py --splits test --data-root-test test_dataset
```

### Full-shot (train on mixed; test on each dataset)

```
python timer-model/predict_glucose_multiwindow_timer_fullshot.py --data-root-train training_dataset/mixed --data-root-test test_dataset
```

### Few-shot

```
python timer-model/predict_glucose_multiwindow_timer_fewshot.py --data-root-train training_dataset/mixed --data-root-test test_dataset
```
